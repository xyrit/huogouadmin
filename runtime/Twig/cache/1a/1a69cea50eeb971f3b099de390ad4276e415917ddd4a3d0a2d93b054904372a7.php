...
/* point.html */
class __TwigTemplate_6c79adbcaaa48b93648ea86db77582378f0a1f7d6ef9518d183181a9166d4750 extends yii\twig\Template
{
...
<head>
    ...
    <script>
        ...
        echo "';
            ...
            var b1 = '";
        // line 18
        echo twig_escape_filter($this->env, (isset($context["invite"]) ? $context["invite"] : null), "html", null, true);
        echo "'.split(\",\");
            var b2 = '";
        // line 19
        ...
        echo "'.split(\",\");
            var b3 = '";
        // line 20
        echo twig_escape_filter($this->env, (isset($context["consume"]) ? $context["consume"] : null), "html", null, true);
        echo "'.split(\",\");
            //var b4 = '";
        // line 21
        ...
        echo "'.split(\",\");
            var b5 = '";
        // line 22
        echo twig_escape_filter($this->env, (isset($context["material"]) ? $context["material"] : null), "html", null, true);
        echo "'.split(\",\");
            var b6 = '";
        // line 23
        echo twig_escape_filter($this->env, (isset($context["buy"]) ? $context["buy"] : null), "html", null, true);
        echo "'.split(\",\");
           ...
           /* \$.each(b4, function(i, v){
            ...
            \$.each(b6, function(i, v){
                b6[i] = parseInt(v);
            })

            //var b2 = [969,1087,1399,1399,1512,1449,2029];
            //var b1 = [955,1146,1414,1414,1668,1570,2027];
            var plot2 = \$.jqplot('chart2', [b1, b2, b3, b5, b6], {
                title: tick2[0] + '到' + tick2[tick2.length-1] + '福分统计',
...
<table id=\"listdata\" class=\"easyui-datagrid\" title=\"福分列表\" data-options=\"toolbar:'#tb-user',singleSelect:true,pagination:true,method:'get',url:'";
        // line 128
    ...
    <tr>
        ...
        <th data-options=\"field:'invite_point', width:150, align:'center'\">邀请福分</th>
        <th data-options=\"field:'material_point', width:150, align:'center'\">资料福分</th>
        <th data-options=\"field:'share_point', width:150, align:'center'\">晒单福分</th>
        <th data-options=\"field:'buy_point', width:150, align:'center'\">购买福分</th>
        <th data-options=\"field:'used_point', width:150, align:'center'\">抵扣福分</th>
        <th data-options=\"field:'left_point', width:150, align:'center'\">福分余额</th>
    </tr>
    </thead>
</table>
    ...
    {
        return array (  217 => 128,  207 => 121,  203 => 120,  196 => 118,  190 => 117,  184 => 116,  88 => 23,  84 => 22,  80 => 21,  76 => 20,  72 => 19,  68 => 18,  63 => 16,  57 => 13,  53 => 12,  49 => 11,  45 => 10,  41 => 9,  37 => 8,  33 => 7,  29 => 6,  25 => 5,  19 => 1,);
    }
}
...
/*             var b1 = '{{ invite }}'.split(",");*/
/*             var b2 = '{{ share }}'.split(",");*/
/*             var b3 = '{{ consume }}'.split(",");*/
/*             //var b4 = '{{ left }}'.split(",");*/
/*             var b5 = '{{ material }}'.split(",");*/
/*             var b6 = '{{ buy }}'.split(",");*/
/*             $.each(b1, function(i, v){*/
/*                 b1[i] = parseInt(v);*/
/*             })*/
...
/* <div id="chart2" style="width: 1000px; height: 400px;"></div>*/
/* */
/* <table id="listdata" class="easyui-datagrid" title="福分列表" data-options="toolbar:'#tb-user',singleSelect:true,pagination:true,method:'get',url:'{{ url('stats/list')}}',nowrap:false,rownumbers: false">*/
/*     <thead>*/
/*     <tr>*/
/*         <th data-options="field:'date', width:150, align:'center'">日期</th>*/
/*         <th data-options="field:'invite_point', width:150, align:'center'">邀请福分</th>*/
