...
/* index.html */
class __TwigTemplate_3f1b237d583e742dd38d2a1186db670d2fd09e648690f590df4c06f32cdc5094 extends yii\twig\Template
{
...
<table id=\"listdata\"  class=\"easyui-datagrid\" title=\"申请列表\" data-options=\"toolbar:'#tb-user',singleSelect:true,pagination:true,method:'get',url:'";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('yii2-twig')->url("/point/index"), "html", null, true);
    ...
    <tr>
        ...
        <th data-options=\"field:'point', width:100, align:'center'\" formatter=\"formatMoney\">福分</th>
...
<!--新增福分调整-->
<div id=\"dlg-add\" title=\"新增福分调整\" class=\"easyui-dialog\" style=\"width:350px;height:auto;padding:10px 20px\" modal=\"true\" closed=\"true\" buttons=\"#dlg-buttons-add\">
    ";
        // line 58
    ...
    <table cellpadding=\"5\">
        ...
        <tr>
            <td>当前福分</td>
            <td><input class=\"easyui-textbox\" type=\"text\" id=\"add_before_point\" data-options=\"readonly: true\"></td>
        </tr>
        <tr>
            <td>操作</td>
            <td>
                <input name=\"PointLog[type]\" type=\"radio\" class=\"easyui-validatebox\" value=\"0\">增加
                <input name=\"PointLog[type]\" type=\"radio\" class=\"easyui-validatebox\" value=\"1\">扣除
            </td>
        </tr>
        <tr>
            <td></td>
            <td>
                <input class=\"easyui-textbox\" type=\"text\" name=\"PointLog[point]\" data-options=\"required:true\">
            </td>
        </tr>
        <tr>
            <td>调整原因</td>
            <td>
                <select class=\"easyui-combobox\" data-options=\"panelHeight:'auto', onSelect:onSelect,required:true\">
                    <option value=\"邀请好友消费未赠送\">邀请好友消费未赠送</option>
                    <option value=\"完善个人资料未赠送\">完善个人资料未赠送</option>
        ...
        <tr class=\"other\">
            <td></td>
            <td>
                <input class=\"easyui-textbox reason\" type=\"text\" name=\"PointLog[reason]\" data-options=\"required:true\">
            </td>
        </tr>
        <tr>
            <td>原始单号</td>
            <td>
                <input class=\"easyui-textbox\" type=\"text\" name=\"PointLog[order]\" data-options=\"required:true\">
            </td>
        </tr>
        <tr>
            <td>备注</td>
            <td>
                <textarea name=\"PointLog[note]\" style=\"width: 173px; height: 100px\"></textarea>
            </td>
        </tr>
        <input type=\"hidden\" name=\"PointLog[user_id]\" id=\"add_user_id\">
    </table>
    ";
        // line 111
...
<!--编辑福分调整-->
<div id=\"dlg-edit\" title=\"编辑福分申请\" class=\"easyui-dialog\" style=\"width:350px;height:auto;padding:10px 20px\" modal=\"true\" closed=\"true\" buttons=\"#dlg-buttons-edit\">
    ";
        // line 122
    ...
    <table cellpadding=\"5\">
        ...
        <tr>
            <td>当前福分</td>
            <td><input class=\"easyui-textbox\" type=\"text\" id=\"before_point\" data-options=\"readonly: true\"></td>
        </tr>
        <tr>
            <td>操作</td>
            <td>
        ...
        <input type=\"hidden\" name=\"PointLog[user_id]\" class=\"user_id\">
    </table>
    ";
        // line 175
        echo $this->getAttribute((isset($context["html"]) ? $context["html"] : null), "endForm", array(), "method");
...
<!--查看福分调整-->
<div id=\"dlg-view\" title=\"查看福分调整\" class=\"easyui-dialog\" style=\"width:450px;height:auto;padding:10px 20px\" modal=\"true\" closed=\"true\">
    <table cellpadding=\"5\">
        <tr>
...
";
    ...
    function onChange(newValue, oldValue) {
        \$.get('/money/user-info', {'account': newValue}, function(data) {
            if (data.error == 0) {
                \$('#add_before_point').textbox('setValue', data.message['point']);
    ...
    function edit() {
        ...
        \$('#editForm').form('clear');
        if (selRow.reason == '邀请好友消费未赠送' || selRow.reason == '完善个人资料未赠送') {
        ...
        \$.get('/money/user-info', {'id': selRow.user_id}, function(data) {
            if (data.error == 0) {
                \$('#before_point').textbox('setValue', data.message['point']);
                if (selRow.phone) {
        ...
        \$('#dlg-edit').form('load',{
            'PointLog[type]' : selRow.type,
            'PointLog[point]' : selRow.point,
            'PointLog[reason]' : selRow.reason,
            'PointLog[order]' : selRow.order,
            'PointLog[note]' : selRow.note,
            'PointLog[user_id]': selRow.user_id
        });
    ...
    function save(flag) {
        if (flag == 'edit') {
            var selRow = \$('#listdata').datagrid('getSelected');
            var url = '/point/edit?id=' + selRow.id;
            var form = 'editForm';
        } else if (flag == 'add') {
            var url = '/point/add';
            var form = 'addForm';
    ...
    function view() {
        ...
        \$.get('/money/user-info', {'id': selRow.user_id}, function(data) {
            if (data.error == 0) {
                \$('#view_point').html(data.message['point']);
            } else {
                \$.messager.alert('错误', data.message);
                return false;
            }
    ...
    function financeApprove(action) {
        ...
        if (action == 'open') {
            ...
            var selRow = \$('#listdata').datagrid('getSelected');
            var url = '/point/finance-approve?id=' + selRow.id;
...
/* </div>*/
/* */
/* <table id="listdata"  class="easyui-datagrid" title="申请列表" data-options="toolbar:'#tb-user',singleSelect:true,pagination:true,method:'get',url:'{{  url('/point/index')}}',mode:'local',pageSize:20">*/
/*     <thead>*/
/*     <tr>*/
/*         <th data-options="field:'id', width:50, align:'center'">序号</th>*/
/*         <th data-options="field:'name', width:200, align:'center'" formatter="formatName">会员</th>*/
