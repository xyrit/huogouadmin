...
/* footer-bar.html */
class __TwigTemplate_47f422e29f583c2dafb1bd446c2182d02b36ef1a80f793ba851fa5860c385062 extends yii\twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("@app/views/base.html", "footer-bar.html", 1);
        $this->blocks = array(
    ...
    {
        // line 4
        echo "<table id=\"listdata\"  class=\"easyui-datagrid\" title=\"底部导航按钮设置\" data-options=\"toolbar:'#tb-user',singleSelect:true,pagination:true,method:'get',url:'";
        echo twig_escape_filter($this->env, $this->env->getExtension('yii2-twig')->url("app/footer-bar"), "html", null, true);
        echo "',pageSize:50\">
    <thead>
...
<div id=\"dlg-add\" title=\"新增\" class=\"easyui-dialog\" style=\"width:350px;height:auto;padding:10px 20px;\" modal=\"true\" closed=\"true\" buttons=\"#dlg-buttons-add\">
    <form id=\"footer-bar\" method=\"post\" enctype=\"multipart/form-data\">
        <table cellpadding=\"5\">
            <tr>
                <td>站点</td>
                <td>
...
";
    ...
    function edit()
    {
        ...
        echo "\" + '?type=footer-bar&id=' + selRow.id);
...
";
    ...
    {
        return array (  200 => 138,  185 => 126,  165 => 109,  155 => 101,  152 => 100,  106 => 57,  99 => 53,  92 => 48,  81 => 46,  77 => 45,  32 => 4,  29 => 3,  11 => 1,);
    }
}
/* {% extends '@app/views/base.html' %}*/
/* */
/* {% block main %}*/
/* <table id="listdata"  class="easyui-datagrid" title="底部导航按钮设置" data-options="toolbar:'#tb-user',singleSelect:true,pagination:true,method:'get',url:'{{ url('app/footer-bar') }}',pageSize:50">*/
/*     <thead>*/
/*     <tr style="height:200px;">*/
/*         <th data-options="field:'from', width:150, align:'center'" formatter="formatFrom">来源</th>*/
/*         <th data-options="field:'system', width:180, align:'center'">系统</th>*/
...
/*             return false;*/
/*         }*/
/*         $('#edit_iframe').prop('src', "{{ url('app/edit') }}" + '?type=footer-bar&id=' + selRow.id);*/
/*         $('#dlg-edit').window('open');*/
/*     }*/
/* */
/*     function del()*/
