...
use app\components\wechat\mp\Card;
use app\components\wechat\mp\ShakeAround;
use app\components\wechat\mp\DataCube;
use app\components\wechat\mp\CustomService;

/**
 * 微信公众号操作SDK
 * 注:部分功能因API的整体和功能性, 拆分为单独的类调用请查看wechat/mp文件夹
